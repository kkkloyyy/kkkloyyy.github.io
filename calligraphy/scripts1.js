...
var calligraphy1 =$('#calligraphy')
console.log(calligraphy1)
for (i=0; i<calligraphy.length;i++)
    {
        
        var card = calligraphy[i];
        var id = card.id;
        var type = card.type;
        ...
        var thumbImgUrl = 'images1/thumb/'+id+'t.jpg';
        ...
        var renderLink = '<a href="images1/full/'+id+'.jpg" data-lightbox="roadtrip">View</a>';
...
//            </div>
        ...
        calligraphy1.append(renderCard)
